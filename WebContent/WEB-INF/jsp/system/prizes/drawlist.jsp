...
<div class="row">
	<div class="col-md-12">
		...
		<h3 class="page-title">
			抽奖列表 <small>抽奖信息</small>
		</h3>
		<ul class="page-breadcrumb breadcrumb">
			<li><i class="fa fa-home"></i> <a href="javascript:void(0)">
					抽奖列表 </a> <i class="fa fa-angle-right"></i></li>
			<li><a href="javascript:void(0)"> 抽奖列表 </a></li>
		</ul>
					...
					<table class="table table-bordered table-hover">
						<thead>
							<tr>
								...
								<th style="width: 10%">抽奖标题</th>
								<th style="width: 35%">抽奖简介</th>
...
<script>
function change(id){
   window.location.href="${DOMAIN}/system/luckdraw/change/"+id;
}

function state(id){
	   window.location.href="${DOMAIN}/system/luckdraw/state?id="+id;
	}
function changeState(id){
	   window.location.href="${DOMAIN}/system/luckdraw/changeState?id="+id;
	}
</script>
<!-- END PAGE CONTENT-->
