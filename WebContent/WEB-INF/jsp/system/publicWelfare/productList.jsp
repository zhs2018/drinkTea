...
<div class="row">
	<div class="col-md-12">
		...
		<h3 class="page-title">
			公益商品列表 <small>公益商品信息</small>
		</h3>
		<ul class="page-breadcrumb breadcrumb">
			<li><i class="fa fa-home"></i> <a href="javascript:void(0)">
					公益商品管理 </a> <i class="fa fa-angle-right"></i></li>
			<li><a href="javascript:void(0)"> 公益商品列表 </a></li>
...
<script>
    ...
    function editor(id){
    	window.location.href="${DOMAIN}/system/welfare/product/editor/"+id;
    }
	  ...
	  function del(id){
		  ...
		  layer.confirm("确定删除该商品吗",{
				...
				function(){
					window.location.href="${DOMAIN}/system/welfare/product/del/"+id;
				},
				function(){
					layer.close();
				})
