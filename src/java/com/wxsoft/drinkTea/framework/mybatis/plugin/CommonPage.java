...
//			System.out.println("currentPage:"+currentPage);
			if (currentPage == 1) {
				...
				sb.append("	<li class=\"pageinfo\"><</li>\n");
			} else {
				sb.append("	<li onclick=\"nextPage(1)\"><a href=\"#@\" >首页</a></li>\n");
				sb.append("	<li  onclick=\"nextPage("
						+ (currentPage - 1) + ")\"><a href=\"#@\"><</a></li>\n");
			}
			...
			for (int i = startTag; i <= totalPage && i <= endTag; i++) {
				if (currentPage == i)
					sb.append("<li class=\"current\">" + i + "</li>\n" +"<span id=\"cur\" hidden=\"true\">"+i+"</span>");
				else
					sb.append("	<li onclick=\"nextPage(" + i
							+ ")\"><a href=\"#@\">" + i + "</a></li>\n");
			}
			if (currentPage == totalPage) {
				...
				sb.append("	<li onclick=\"nextPage("
						+ (currentPage + 1) + ")\"><a href=\"#@\">></a></li>\n");
				sb.append("	<li onclick=\"nextPage(" + totalPage
						+ ")\"><a href=\"#@\" >尾页</a></li>\n");
			}
