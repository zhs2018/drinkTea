			...
			<div class="widget_wrap">
				<ul>
					<li style="background: #666666"><a
						href="${SHOPDOMAIN }/front/shop/indexv.html" class="on"
						style="color: #FFFFFF"> <span class="icon-wmfont wm-home"></span>
							首页
					</a></li>
					<li style="background: #666666"><a
						href="${SHOPDOMAIN }/front/shop/showcar.html?userid=" class="on"
					...
					<!-- <li style="background: #666666"><a
						href="${SHOPDOMAIN }/front/shop/catalist.html" class="on"
