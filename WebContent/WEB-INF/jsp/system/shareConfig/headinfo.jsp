	...
	<div class="col-md-12">
		...
		<ul class="page-breadcrumb breadcrumb">
			<li><i class="fa fa-home"></i> <a href="javascript:void(0)">
					系统设置 </a> <i class="fa fa-angle-right"></i></li>
			<li><a href="javascript:void(0)"> 分享信息 </a></li>
		</ul>
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				...
				<form class="form-horizontal" method="post" id="form_config"
					enctype="multipart/form-data" action="saveheadinfo"
					...
					<div class="form-body">
						...
						<div class="form-group">
							<label class="control-label col-md-3">首页标题： <span class="required"> * </span></label>
							<div class="col-md-4">
								<input type="text" class="form-control w_require"
									value="${obj.firstTitle}" name="firstTitle"> <input type="hidden"
									value="${obj.id }" name="id">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3">分享标题： <span class="required"> * </span> </span> </label>
							<div class="col-md-4">
								<input type="text" class="form-control"
									value="${obj.shareTitle }" name="shareTitle">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3">分享描述： <span class="required"> * </span> </label>
							<div class="col-md-4">
								<input type="text" class="form-control"
									value="${obj.shareDesc}" name="shareDesc">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3">分享图片：<span
								class="required"> * </span>
							</label>
							<div class="col-md-4">
								<div data-provides="fileinput" class="fileinput fileinput-new">
									...
									<c:if test="${not empty obj.sharePic}">
									<%-- ${RESOURCEDOMAIN}/${fn:replace(obj.prizeImg,'.','_800_600.')} --%>
										<br>
										<br>
										<img src="${RESOURCEDOMAIN}/${obj.sharePic}" height="200px"
											width="400px" />
									</c:if>
								</div>
							</div>
