		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				...
				<form class="form-horizontal" id="form_config" method="post"
					action="${DOMAIN}/system/commodity/addcomm" novalidate="novalidate"
					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" class="form-control w_require"
									...
									value="${manageProducts.id}" name="id" hidden="true"> <input
									type="text" value="${cur}" name="cur" hidden="true">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3">选择商品类型： <span
								class="required"> * </span>
							</label>
							<div class="col-md-4">
								<select name="tab">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" class="form-control w_price"
									value="${manageProducts.cost }" id="cost" name="cost"
									style="width: 220px;">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" class="form-control w_require"
									value="${manageProducts.type }" id="type" name="type"
									style="width: 240px;">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3">商品库存： <span
								class="required"> * </span>
							</label>
							<div class="col-md-4">
								<input type="text" class="form-control w_kucun"
									value="${manageProducts.restGoods}" id="restGoods"
									name="restGoods" style="width: 300px;">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" class="form-control w_require"
									value="${manageProducts.specifications }" id="specifications"
									name="specifications" style="width: 400px;">
							</div>
						</div>
						<div class="form-group">
