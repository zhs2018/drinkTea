...
<div class="row">
	<div class="col-md-12">
		...
		<ul class="page-breadcrumb breadcrumb">
			...
			<li><a href="javascript:void(0)"> 退款申请列表 </a></li>
		</ul>
						...
						<div class="tabbable tabbable-custom">
							<ul class="nav nav-tabs">
								<li class="gt-1"><a data-toggle="tab" href="#tab_1_1"
									>所有申请(${empty shenqing ? 0 :shenqing})</a></li>
							</ul>
								...
								<div id="tab_1_1" class="tab-pane active">
									<div class="table-responsive" style="margin-top: 10px">
										<table class="table table-bordered table-hover"
											...
											<thead>
												<tr>
													<th style="text-align: center;width:80px">订单编号</th>
													<th style="text-align: center;width:20%">商品名称</th>
													<th style="text-align: center;width:20%">买家姓名</th>
													<th style="text-align: center;width:20%">实付金额</th>
													...
													<c:when test="${not empty orResultlist}">
														<c:forEach items="${orResultlist}" var="orders" varStatus="vs">
															<tr class="" style="height: 50px">
																...
																<td style="width:10%;text-align: center;vertical-align: middle;">${orders.goodsName}</td>
																<td
																	style="width:20%;text-align: center;vertical-align: middle;">${orders.userName}</td>
																<td
																	style="width:10%;text-align: center;vertical-align: middle;">￥${orders.money}</td>
																<td
																	style="width:20%;text-align: center;vertical-align: middle;">${orders.reason}</td>
																<td
																	style="width:20%;text-align: center;vertical-align: middle;">${orders.remark}</td>
																<td style="width:20%;text-align: center;vertical-align: middle;">
																	<span style="color: red">
																		<c:choose>
																			<c:when test="${ orders.stat==-1}">未审核</c:when>
																		</c:choose>
																	</span>
																</td>
																<td style="width:10%;text-align: center;vertical-align: middle;">
																	<c:choose>
																		<c:when test="${ orders.stat==-1}">
																			<a class="btn big   green" style="margin-top: 10px"
																				onclick="fahuo(${orders.id})"
																				href="javascript:void(0)"> <i class=""></i> 开始审核
																			</a>
																			<br>
																		</c:when>
																	</c:choose>
