...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        moment.lang("zh-cn", {
            ...
            meridiem: function (a, e) {
                return 9 > a ? "早上" : 11 > a && 30 > e ? "上午" : 13 > a && 30 > e ? "中午" : 18 > a ? "下午" : "晚上"
            },
            calendar: {
                sameDay: "[今天]LT",
                nextDay: "[明天]LT",
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    '<div class="daterangepicker_start_input" style="float: left">' +
                      ...
                      '<input class="input-mini" type="text" name="daterangepicker_start" value="" disabled="disabled" style="width: 70px;" />' +
                    '</div>' +
                    '<div class="daterangepicker_end_input" style="float: left; padding-left: 11px">' +
                      '<label for="daterangepicker_end">' + this.locale.toLabel + '</label>' +
                      '<input class="input-mini" type="text" name="daterangepicker_end" value="" disabled="disabled" style="width: 70px;" />' +
                    '</div>' +
        ...
        if (hasOptions) {
            ...
            if (typeof options.oldsubmit == 'boolean') {
                this.oldsubmit = options.oldsubmit;
            }
    ...
    DateRangePicker.prototype = {
        ...
        hide: function (e) {
            this.container.hide();
            var o;
            if (typeof e == 'boolean') { o = e; }
            if ((!this.startDate.isSame(this.oldStartDate) || !this.endDate.isSame(this.oldEndDate) || this.oldsubmit) && o)
                this.notify();
