	...
	<div class="col-md-12">
		...
		<ul class="page-breadcrumb breadcrumb">
			<li><i class="fa fa-home"></i> <a href="javascript:void(0)">
					奖品设置 </a> <i class="fa fa-angle-right"></i></li>
			<li><a href="javascript:void(0)"> 奖品信息 </a></li>
		</ul>
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				...
				<form class="form-horizontal" method="post" id="form_config"
					enctype="multipart/form-data" action="save" novalidate="novalidate">
					<div class="form-body">
						...
						<div class="form-group">
							<label class="control-label col-md-3">奖品名称 ： <span
								class="required"> * </span></label>
							<div class="col-md-4">
								<input type="text" class="form-control w_require"
									value="${obj.prizeName }" name="prizeName"> <input
									type="hidden" value="${obj.id }" name="id">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3">奖品类型 ： </label>
							<div class="col-md-4">
								<input type="text" class="form-control"
									value="${obj.prizeType }" name="prizeType">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3">奖品数量 ： </label>
							<div class="col-md-4">
								<input type="text" class="form-control w_weight"
									value="${obj.prizeNum}" name="prizeNum">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3">奖品图片(建议800*600以上)：<span
								class="required"> * </span>
							</label>
							<div class="col-md-4">
