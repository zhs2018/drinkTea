		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				...
				<form class="form-horizontal" id="form_config" method="post"
					action="${DOMAIN}/system/prizes/product/save"
					...
					<div class="form-body">
						...
						<div class="form-group">
							<label class="control-label col-md-3">商品数量： <span
								class="required"> * </span>
							</label>
							<div class="col-md-4">
								<input type="text" class="form-control w_require"
									value="${manageProducts.restGoods }" name="restGoods"
									style="width: 300px;">
							</div>
						</div>
						<div class="form-group">
								...
								<div data-provides="fileinput" class="fileinput fileinput-new">
									<div class="input-group input-large">
										...
										<span class="input-group-addon btn default btn-file"> <span
											...
											name="myfile" accept="image/gif,image/jpeg,image/jpg,image/png">
										</span>
								...
								<div data-provides="fileinput" class="fileinput fileinput-new">
									<div class="input-group input-large">
										...
										<span class="input-group-addon btn default btn-file"> <span
											class="fileinput-new"> 选择文件 </span> <span
											class="fileinput-exists"> Change </span><input type="file"
											name="myfile1" accept="image/gif,image/jpeg,image/jpg,image/png">
										</span>
									</div>
								...
								<div data-provides="fileinput" class="fileinput fileinput-new">
									<div class="input-group input-large">
										...
										<span class="input-group-addon btn default btn-file"> <span
											class="fileinput-new"> 选择文件 </span> <span
											class="fileinput-exists"> Change </span><input type="file"
											name="myfile2" accept="image/gif,image/jpeg,image/jpg,image/png">
										</span>
									</div>
