				...
				<form class="form-horizontal" method="post" id="form_config"
					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="number" class="form-control" name="jobNumber" value="">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<!-- 	<label><input type="radio" value="1" name="roleId"/>系统管理员</label>
								<label><input type="radio" value="2" name="roleId" checked = "checked"/>普通员工</label> -->
							</div>
						</div>
						<div class="form-group">
...
<script>
	function saveUser(){
		...
		$.ajax({
			url:"${DOMAIN}/system/user/saveUser",
			type:"post",
			data:sub,
			dataType:"json",
