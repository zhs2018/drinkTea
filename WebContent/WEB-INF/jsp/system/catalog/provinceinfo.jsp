...
<div class="row">
	<div class="col-md-12">
		...
		<h3 class="page-title">
			选项设置 <small>省份选项信息</small>
		</h3>
		<ul class="page-breadcrumb breadcrumb">
			<li><i class="fa fa-home"></i> <a href="javascript:void(0)">
					省份设置 </a> <i class="fa fa-angle-right"></i></li>
			<li><a href="javascript:void(0)"> 省份信息 </a></li>
		</ul>
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				...
				<form class="form-horizontal" id="form_config" method="post"
					enctype="multipart/form-data" action="${DOMAIN}/system/province/save"
					...
					<div class="form-body">
						...
						<div class="form-group">
							<label class="control-label col-md-3">省份名称 ： <span
								class="required"> * </span>
							</label>
							<div class="col-md-4">
								<input type="text" class="form-control w_require"
									value="${pm.provinceName}" name="provinceName"> <input type="hidden"
									value="${pm.id }" name="id">
									<input type="hidden"
									value="${cur}" name="cur">
							</div>
