...
<form  action="${RESOURCEDOMAIN}/myfeed" novalidate="novalidate" method="post" id="formId">
...
function saveContent(){
	...
	$.ajax({
		...
		success:function(data){
			if(data.status == "1"){
			window.location.href="${RESOURCEDOMAIN}/personalCenter";
