...
<div class="row">
	<div class="col-md-12">
		...
		<h3 class="page-title">
			倒计时时间 <small>&nbsp;&nbsp;倒计时</small>
		</h3>
		<ul class="page-breadcrumb breadcrumb">
			<li><i class="fa fa-home"></i> <a href="javascript:void(0)">
					倒计时</a> <i class="fa fa-angle-right"></i></li>
			<li><a href="javascript:void(0)"> 编辑倒计时 </a></li>
		</ul>
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				...
				<form class="form-horizontal" method="post" id="form_config"
					action="${DOMAIN}/system/tking/refundTime/save">
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" class="form-control w_require" value="茶王争霸赛"
									readonly> <input type="text" value="${refundTime.id }"
									name="id" id="id" hidden="true" />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3">倒计时（毫秒） ： <span
								class="required"> * </span></label>
							<div class="col-md-4">
								<input type="text" class="form-control w_require" name="time"
									id="time" value="${refundTime.time}">
							</div>
						</div>
					</div>
			</div>
