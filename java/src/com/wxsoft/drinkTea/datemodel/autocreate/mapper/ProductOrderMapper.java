...
import com.wxsoft.drinkTea.datemodel.autocreate.model.ProductOrder;;

/**
 * @文件名称: ProductOrderMapper.java
 * @类路径: com.wxsoft.drinkTea.datemodel.autocreate.mapper.ProductOrderMapper;
 * @作者：
 * @公司：
 */
@Repository
public interface  ProductOrderMapper {
	...
	// 根据所需查询实例
	ProductOrder selectBy(ProductOrder record);
