...
public class luckdrawProductController extends BaseAction{
	/**
	 *
	 */
	private static final long serialVersionUID = 1L;
		...
		public ModelAndView productAdd() {
			...
			mv.setViewName(SCHOOLMGR.SYSTEM_PATH_ADMIN + "/prizes/addproduct");
			return mv;
		}
		...
		public ModelAndView productList(ManageProducts mp) {
			...
			mv.addObject("obj", mp);
			mv.setViewName(SCHOOLMGR.SYSTEM_PATH_ADMIN + "/prizes/productList");
			return mv;
		}
		...
		public String updatecomm(HttpSession session, HttpServletRequest request, ManageProducts rf,
			...
			return "redirect:" + SCHOOLMGR.SYSTEM_PATH_ADMIN + "/prizes/product/list";
		}
		...
		public ModelAndView deleteUse(@PathVariable Integer id, HttpServletResponse response) {
		    ...
		    mv.setViewName("redirect:"+SCHOOLMGR.SYSTEM_PATH_ADMIN + "/prizes/product/list");
			return mv;
		}
		...
		public ModelAndView editUser(@PathVariable Integer id) {
			ModelAndView mv = new ModelAndView(SCHOOLMGR.SYSTEM_PATH_ADMIN + "/prizes/addproduct");
