...
<div class="verticalScreen">
    ...
    <div class="plays_operation">
        ...
        <a href="${RESOURCEDOMAIN}/shop/seeOrders/${order.id}/${order.orderState}"><div class="plays-productionOrder" >查看订单</div></a>
        <a href="${RESOURCEDOMAIN}/shop/manageCity"><div class="plays-return">返回首页</div></a>
    </div>
