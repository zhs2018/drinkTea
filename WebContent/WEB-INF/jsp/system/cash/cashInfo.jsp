...
<div class="row">
	<div class="col-md-12">
		...
		<h3 class="page-title">
			红包设置 <small>红包金额设置</small>
		</h3>
		<ul class="page-breadcrumb breadcrumb">
			<li><i class="fa fa-home"></i> <a href="javascript:void(0)">
					红包金额设置 </a> <i class="fa fa-angle-right"></i></li>
			<li><a href="javascript:void(0)"> 红包信息 </a></li>
		</ul>
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				...
				<form class="form-horizontal" id="form_config" method="post"
					enctype="multipart/form-data" action="${DOMAIN}/system/cash/saveCash"
					...
					<div class="form-body">
						...
						<div class="form-group">
							<label class="control-label col-md-3">红包金额： <span
								class="required"> * </span>
							</label>
							<div class="col-md-4">
								<input type="text" class="form-control w_require"
									value="${cashOut.redMoney }" name="redMoney"> <input
									type="hidden" value="${cashOut.id }" name="id">
							</div>
						</div>
